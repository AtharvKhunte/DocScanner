...
private val DarkColorScheme = darkColorScheme(
    ...
    surface         = DocVaultColors.CardSurface,
    onSurface       = DocVaultColors.TextPrimary,
    surfaceVariant  = DocVaultColors.CardSurface,
    onSurfaceVariant= DocVaultColors.TextSecondary,
    outline         = DocVaultColors.Border,
